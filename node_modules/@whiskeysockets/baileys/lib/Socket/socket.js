...
const makeSocket = (config) => {
    var _a, _b;
    const { waWebSocketUrl, connectTimeoutMs, logger, keepAliveIntervalMs, browser, auth: authState, printQRInTerminal, defaultQueryTimeoutMs = undefined, transactionOpts, qrTimeout, makeSignalRepository, } = config;
    ...
    const requestPairingCode = async (phoneNumber, code) => {
        ...
        if (code && (code === null || code === void 0 ? void 0 : code.length) !== 8) {
